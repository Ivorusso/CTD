...
def porcentaje():
        if puntajeTotal > 0: 
            ...
            # 1) agrega una condicion para abarcar el caso en el cual el 
            # puntaje total sea 0, y evitar que al no entrar en el if, 
            # quede en el aire devolviendo un undefined (none).
